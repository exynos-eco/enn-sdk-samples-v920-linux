...
#define TEST_MODEL_PATH_ESRGAN_X4PLUS "/data/vendor/midas/real_esrgan_x4plus_simplify_O2_SingleCore.nnc"
#define TEST_INPUT_FILE_PATH "/data/vendor/midas/media/image.jpg"
